...
# CORS allows your React frontend (running on port 5173) to talk to this backend (running on port 8000)
...
def login(user_credentials: schemas.UserCreate, db: Session = Depends(get_db)):
    ...
    Note: We reuse UserCreate schema here because it has email + password.
    In a real app, you might create a separate LoginRequest schema.
    """
    # Find user by email
